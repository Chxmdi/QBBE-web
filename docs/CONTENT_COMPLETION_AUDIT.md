...
| Build and regression checks | `npm run lint`, `npm test`, `npm run build` | Passed on 2026-08-17; 18 migration-focused tests, source-traceability guard, and 44 localized static pages | Browser/device/accessibility audit against deployed preview |
