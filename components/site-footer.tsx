...
export function SiteFooter({ locale }: { locale: Locale }) {
  return <footer className="site-footer">
    <div className="shell footer-grid">
      <div><h3>QBBE</h3><p style={{ color: "rgba(255,255,255,.75)", lineHeight: 1.6, maxWidth: 360 }}>Empowering students. Strengthening families. Transforming education across Quebec.</p><Link className="button button--gold" href={localePath(locale, "/donate")}>{locale === "en" ? "Support our mission" : "Soutenir notre mission"}</Link></div>
